...
import { ExternalLink, Github, Info, Server } from 'lucide-react'
  ...
  const projects = [
    {
      ...
      description: (
        <>
          <small className='text-gray-400 mb-2 tracking-wide flex items-center gap-2'>
            <Info className='w-4 h-4 sm:w-5 sm:h-5 shrink-0 text-blue-400' />
      ...
      demo: {
        frontend: 'https://soulbeat.netlify.app/',
        backend: 'https://soulbeat-backend.onrender.com',
      },
      isMain: true 
    },
    {
...
,
      ...
      demo: 'https://dashboard-paises.onrender.com', 
    },
    {
      ...
      <div className="space-y-14 lg:space-y-16">
        ...
        >
          ...
          <div className="relative overflow-hidden aspect-video bg-neutral-900 shrink-0">
            ...
            <div className="absolute inset-0 bg-linear-to-t from-black/60 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4 gap-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <a
                  ...
                  className="p-2 rounded-full hover:bg-pink-600/70 text-white transition-colors duration-300 flex items-center justify-center"
              ...
              {/* Backend Render */}
              <div className="flex flex-col items-center">
                <span className="text-xs text-white tracking-wider mb-1">Server</span>
                <a
                  href={projects[0].demo.backend}
                  className="p-2 rounded-full hover:bg-pink-600/70 text-white transition-colors duration-300 flex items-center justify-center"
                  aria-label="Backend Render"
               ...
               {/* Demo Frontend */}
              <div className="flex flex-col items-center">
                <span className="text-xs text-white tracking-wider mb-1">Demo</span>
                <a
                  href={projects[0].demo.frontend}
                  className="p-2 rounded-full hover:bg-pink-600/70 text-white transition-colors duration-300 flex items-center justify-center"
                  aria-label="Demo Frontend"
                  title="Demo Frontend"
                  target="_blank"
                  rel="noopener noreferrer"
                >
          ...
          {projects.slice(1).map((project, index) => (
            ...
            >
              ...
              <div className="relative overflow-hidden aspect-video shrink-0">
                ...
                {/* Overlay con botones de GitHub y Demo que aparecen al hover */}
                <div className="absolute inset-0 bg-linear-to-t from-black/40 to-transparent opacity-50 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4 gap-4">
                  {project.github &&
                  // Botón de GitHub
                  <a
                    href={project.github}
                    className="p-2 rounded-full hover:bg-pink-600/70 text-white transition-colors duration-300"
                    aria-label="GitHub"
                    title="GitHub"
                    target="_blank"
                    rel="noopener noreferrer"
